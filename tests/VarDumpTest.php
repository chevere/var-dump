...
final class VarDumpTest extends TestCase
{
    ...
    public function testCircularReferenceArguments(): void
    {
        ...
        1: stdClass#{$objectId}
         +\$circular stdClass#{$objectId} (circular reference #{$objectId})
    ...
    public function testWithObjectNeedsPullUp(): void
    {
        ...
        2: <span class="chv-dump-class">stdClass</span><span class="chv-dump-operator">#{$twoId}</span><details class="chv-dump-details" open><summary class="chv-dump-summary"></summary> <span class="chv-dump-modifier">+</span><span class="chv-dump-variable">\$zero</span> <span class="chv-dump-int">int</span> 0 <em><span class="chv-dump-emphasis">(length=1)</span></em>
         <span class="chv-dump-modifier">+</span><span class="chv-dump-variable">\$one</span> <span class="chv-dump-int">int</span> 1 <em><span class="chv-dump-emphasis">(length=1)</span></em></details>

        3: <span class="chv-dump-class">stdClass</span><span class="chv-dump-operator">#{$threeId}</span><details class="chv-dump-details" open><summary class="chv-dump-summary"></summary> <span class="chv-dump-modifier">+</span><span class="chv-dump-variable">\$nested</span> <span class="chv-dump-class">stdClass</span><span class="chv-dump-operator">#{$nestedId}</span>
         <span class="chv-dump-modifier">+</span><span class="chv-dump-variable">\$two</span> <span class="chv-dump-class">stdClass</span><span class="chv-dump-operator">#{$twoId}</span><details class="chv-dump-details"><summary class="chv-dump-summary"></summary>  <span class="chv-dump-inline"></span> <span class="chv-dump-modifier">+</span><span class="chv-dump-variable">\$zero</span> <span class="chv-dump-int">int</span> 0 <em><span class="chv-dump-emphasis">(length=1)</span></em>
          <span class="chv-dump-inline"></span> <span class="chv-dump-modifier">+</span><span class="chv-dump-variable">\$one</span> <span class="chv-dump-int">int</span> 1 <em><span class="chv-dump-emphasis">(length=1)</span></em></details>
         <span class="chv-dump-modifier">+</span><span class="chv-dump-variable">\$three</span> <span class="chv-dump-bool">bool</span> false</details>
        ------------------------------------------------------------
